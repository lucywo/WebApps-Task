function togglePasswordVisibility() { // Eine Funktion namens "togglePasswordVisibility" wird definiert.
  let  passwordInput = document.getElementById("password-input"); // Das HTML-Element mit der ID "password-input" wird der Variablen "passwordInput" zugewiesen.
  let toggleButton = document.getElementById("toggle-button"); // Das HTML-Element mit der ID "toggle-button" wird der Variablen "toggleButton" zugewiesen.
